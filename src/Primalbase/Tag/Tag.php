...
class Tag {
  ...
  */
  ...
  public function __construct($tagName)
  {
    ...
    $doc_type_class     = 'Primalbase\Tag\DocType\\'.ucfirst(self::$DocType);
    $doc_type_file_name = 'DocType/'.ucfirst(self::$DocType).'.php';
    require_once __DIR__.'/'.$doc_type_file_name;
